...
async def cmd_help(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "/top — top 5 biggest expenses this month \\(current cycle when cycles are on\\)\n"
        "/report — full monthly report with month\\-over\\-month deltas \\(cycle\\-scoped when cycles are on\\)\n"
